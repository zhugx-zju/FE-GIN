...
def parse_args():
    ...
    parser.add_argument(
        "--checkpoint",
        default=None,
        help="Checkpoint path; defaults to the newest checkpoint in the NeuralOperator output directory.",
    )
...
def run_testing(args=None):
    ...
    search_root = args.output_root or config_fno_neuralop.output_dir
    try:
